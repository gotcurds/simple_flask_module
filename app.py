...
class Customers(Base):
    ...
    service_ticket: Mapped[list['Service_Tickets']] = relationship('Service_Ticket', back_populates='customer')
...
class Mechanics(Base):
    ...
    service_ticket: Mapped[list["Service_Tickets"]] = relationship("Service_Tickets",secondary=service_mechanics, back_populates="mechanic")
